...
%
% Everything from here to "END PREAMBLE" is the preamble.  Copy it whole.
% =============================================================================
...
\ExplSyntaxOn
\NewDocumentCommand \PickFont { m m }
  {
    \tl_clear_new:N #1
    \clist_map_inline:nn {#2}
      { \tl_if_empty:NT #1 { \IfFontExistsTF {##1} { \tl_set:Nn #1 {##1} } { } } }
    \tl_if_empty:NT #1
      { \msg_warning:nnn { template } { nofont } {#2} }
  }
...
\babelfont[chinese-traditional]{rm}[\CJKaxis{700}]{\CJKSerif}
\babelfont[chinese-traditional]{sf}[\CJKaxis{700}]{\CJKSans}
\babelfont[chinese-traditional]{tt}[\CJKaxis{700}]{\CJKMono}
